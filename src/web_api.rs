...
pub fn setup_web_apis(context: &mut Context) -> Result<(), boa_engine::JsError> {
    ...
    setup_structured_clone(context)?;
    Ok(())
}
...
fn setup_base64(context: &mut Context) -> Result<(), boa_engine::JsError> {
    context.eval(boa_engine::Source::from_bytes(
        r#"
...
fn setup_structured_clone(context: &mut Context) -> Result<(), boa_engine::JsError> {
    context.eval(boa_engine::Source::from_bytes(
        r#"
